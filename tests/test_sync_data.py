...
def test_upload(tmp_path):
    ...
    sync_data.upload_yaml(source_yaml=path_to_mini_yaml, raw_data_folder=tmp_path, mode='overwrite')
    ...
    sync_data.upload_yaml(source_yaml=path_to_parsed, raw_data_folder=tmp_path, mode='overwrite')